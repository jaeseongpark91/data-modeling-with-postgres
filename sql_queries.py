...
CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time int, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar)
""")
...
INSERT INTO songplays (songplay_id, user_id, level, song_id, artist_id, session_id, location, user_agent) VALUES (DEFAULT, %s, %s, %s, %s, %s, %s, %s)
""")
...
time_table_insert = ("""
INSERT INTO times (hour, day, week, month, year, weekday) VALUES (%s, %s, %s, %s, %s, %s)
""")
